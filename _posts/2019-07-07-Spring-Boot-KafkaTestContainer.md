...
We will use the same project which explained in detail at [Spring Boot Kafka post](https://muzir.github.io/2019/05/25/Spring-Boot-Kafka.html#springBootKafkaConfiguration). Please refer previous link for all configuration details.
